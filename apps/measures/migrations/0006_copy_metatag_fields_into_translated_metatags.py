# Generated by Django 3.2.19 on 2023-05-17 09:50

from django.db import migrations


def copy_old_metatag_info(apps, schema_editor):
    MeasuresOverviewPage = apps.get_model('apps_measures', 'MeasuresOverviewPage')
    for page in MeasuresOverviewPage.objects.all():
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('apps_measures', '0005_add_translatable_metatag_fields'),
    ]
